...
const socialGoogle = (c) => c.includeAuth && c.socialProviders?.includes('google');
const socialApple = (c) => c.includeAuth && c.socialProviders?.includes('apple');
const ts = (c) => c.isTs;
...
export const manifest = [
  ...
  {
    template: '{lang}/src/models/user.model.{ext}.ejs',
  ...
  // ── Auth module ──────────────────────────────────────────────────────────────
  {
    template: '{lang}/src/modules/auth/auth.controller.{ext}.ejs',
    dest: 'src/modules/auth/auth.controller.{ext}',
    when: auth,
  },
  {
    template: '{lang}/src/modules/auth/auth.validation.{ext}.ejs',
    dest: 'src/modules/auth/auth.validation.{ext}',
    when: auth,
  },
  {
    template: '{lang}/src/modules/auth/auth.routes.{ext}.ejs',
  ...
  // ── Social sign-in verifier services ────────────────────────────────────────
  {
    template: '{lang}/src/services/social/google.service.{ext}',
    dest: 'src/services/social/google.service.{ext}',
    when: socialGoogle,
  },
  {
    template: '{lang}/src/services/social/apple.service.{ext}',
    dest: 'src/services/social/apple.service.{ext}',
    when: socialApple,
  },
  {
